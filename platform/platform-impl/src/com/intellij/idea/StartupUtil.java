...
public final class StartupUtil {
  ...
  public static void start(@NotNull String mainClass,
    ...
    Activity activity = StartUpMeasurer.startActivity("ForkJoin CommonPool configuration");// ActivityImpl
    ...
    lockSystemDirs(configPath, systemPath, args);    // configPath: config/idea, systemPath: system/idea
